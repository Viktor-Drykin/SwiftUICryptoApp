...
class DeveloperPreview {
    ...
    private init() { }
        ...
        let positiveStat = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
        let noPercentage = StatisticModel(title: "Total Volume", value: "$1.23Tr")
        let negativeStat = StatisticModel(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
